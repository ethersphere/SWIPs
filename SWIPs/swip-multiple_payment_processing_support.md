...
The approach proposed in this document of implementing pluggable payment modules that comforms to a common API was designed to overcome the limitations and complexities of the three options mentioned above.
