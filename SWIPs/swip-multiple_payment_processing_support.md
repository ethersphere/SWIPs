...
This SWIP is part of a series of SWIPs (but can be implemented on its own). To see the full picture, please refer to [swip-message_to_honey](https://github.com/Eknir/SWIPs/blob/SWIP-message_to_honey/SWIPs/swip-message_to_honey.md), [swip-honey_to_money](https://github.com/Eknir/SWIPs/blob/SWIP-honey_to_money/SWIPs/swip-honey_to_money.md) and the diagram below:
